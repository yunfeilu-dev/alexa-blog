...
class GptSearchIntentHandler(AbstractRequestHandler):
    """Handler for Hello World Intent."""

    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.is_intent_name("GptSearchIntent")(handler_input)
...
sb.add_request_handler(GptSearchIntentHandler())
